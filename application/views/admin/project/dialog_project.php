...
<div class="modal-body">
  <table class="footable-details table table-striped table-hover toggle-circle">
    <tbody>
      ...
      <?php endif; ?>
      <?php if($status=='3'):?>
      <?php $projectStatus = $this->lang->line('xin_deffered');?>
      <?php endif; ?>
      <tr>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="form-group">
        ...
        <textarea class="form-control" placeholder="<?php echo $this->lang->line('xin_summary');?>" name="summary" cols="30" rows="2" id="summary"><?php echo $summary;?></textarea>
      </div>
    </div>
  </div>
</div>
