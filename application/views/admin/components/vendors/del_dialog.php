...
<div class="modal fadeInLeft delete-modal animated " role="dialog" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?php if($this->router->fetch_class() =='quotes') { ?>
        <div class="modal-body">
        <div class="row">
         <div class="col-md-12">   
            <div class="form-group">
            <label for="project_po"><?php echo $this->lang->line('xin_quote_password');?></label>
            <input type="text" class="form-control" name="quote_password" id="quote_password" value=""><p>
            <small><?php echo $this->lang->line('xin_quote_password');?>: 1234</small></p>
            </div>
          </div>
        </div>
        </div>
