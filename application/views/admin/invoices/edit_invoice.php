            ...
            <div class="bg-white">
              <div class="box-block">
                ...
                <div class="row no-print">
                  <div class="col-xs-12">
                    <button type="submit" class="btn btn-primary pull-right" name="invoice_submit" style="margin-right: 5px;"> <i class="fa fa fa-check-square-o"></i> Submit Invoice </button>
                  </div>
                </div>
              </div>
            </div>
