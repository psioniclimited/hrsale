          ...
          <li>
            <h4 class="control-sidebar-subheading"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <?php echo $f_name;?> <span class="caret"></span></a> <span class="pull-right"><span class="list-group-item-text text-muted" id="hr_status"><?php echo $status_title;?></span></span>
              <ul class="dropdown-menu animated flipInY" role="menu">
                <li><a class="dropdown-item online-status" href="#" data-status-id="1" data-status-title="I'm Available" data-avatar-status="avatar-online">Available</a></li>
                <li><a class="dropdown-item online-status" href="#" data-status-id="2" data-status-title="I'm Away" data-avatar-status="avatar-away">Away</a></li>
                <li><a class="dropdown-item online-status" href="#" data-status-id="3" data-status-title="I'm Busy" data-avatar-status="avatar-busy">Busy</a></li>
              </ul>
            </h4>
